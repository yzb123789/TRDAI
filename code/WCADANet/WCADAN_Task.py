...
class WCADANetClassifier(WCADANsModel):
    def __post_init__(self):
        ...
        # Use BCEWithLogitsLoss for binary classification and retain logits output
        self._default_loss = F.binary_cross_entropy_with_logits  # Use BCEWithLogitsLoss for binary classification
